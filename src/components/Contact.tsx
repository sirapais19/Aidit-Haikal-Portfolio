...
export const Contact = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    // EmailJS integration will be added manually
  ...
  return (
    <section className="py-20 px-4 bg-gradient-to-br from-slate-900 via-purple-900 to-indigo-900 text-white relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        <div className="absolute top-0 left-0 w-96 h-96 bg-cyan-500/10 rounded-full mix-blend-multiply filter blur-3xl animate-blob"></div>
        ...
        <div className="absolute bottom-0 left-1/2 w-96 h-96 bg-blue-500/10 rounded-full mix-blend-multiply filter blur-3xl animate-blob animation-delay-4000"></div>
      </div>
              ...
              <div className="space-y-4">
                ...
                >
                  <a 
                    ...
                    rel="noopener noreferrer"
                  >
                    <Github className="h-5 w-5 mr-3 group-hover:animate-bounce" />
                    Portfolio Website
                  </a>
                </Button>
              </div>
